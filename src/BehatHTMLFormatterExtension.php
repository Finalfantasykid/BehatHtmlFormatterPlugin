...
namespace dwt\BehatHTMLFormatter;
...
class BehatHTMLFormatterExtension implements ExtensionInterface
{
    ...
    {
        $builder->children()->scalarNode('name')->defaultValue('dwthtml');
    ...
    {
        $definition = new Definition('dwt\\BehatHTMLFormatter\\Formatter\\BehatHTMLFormatter');
